...
/system/bin/ip link set dev radio0 up
...
/vendor/bin/execns2 ${NAMESPACE} /system/bin/ip link set dev radio0-peer up
/vendor/bin/execns2 ${NAMESPACE} sysctl -wq net.ipv4.ip_forward=1
